...
#   - months_left
#   - months_to_entry
#months_left = int(input("How many months are left before your passport expires?: "))
#months_to_entry = int(input("how many months until your intended travel date?: "))
...
def check_validity(months_left, months_to_entry):
    ...
    if (months_left - months_to_entry) >= 6:        #Check if user's passport is valid for entry 
        ...
        print("Your passport needs to be renewed") #Modify to display that user needs to renew his passport        
