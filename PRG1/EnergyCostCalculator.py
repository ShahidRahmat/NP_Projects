...
#======================
#power_rating = float(input("Enter the power rating of the device: "))
#hours = float(input("Enter the number of hours that the device is used per day: "))


#Perform monthly energy cost calculation 
def calculate_cost(power_rating,hours):
    #Formula to calculate monthly electricity consumption
    consumption = (power_rating * hours) / 1000
    #Formula to calculate monthly energy cost
    cost = consumption * 0.2156
    print(cost) #Modify to display the calculated energy cost value
